                    ...
                    <div class="col-md-1 col-lg-1"></div>
                            <div class="col-sm-10 col-md-10 col-lg-10">
                                <div class="card border-0 rounded-lg mt-3">
                                    <div class="card-body">
                                        <form  method="POST" action="{{ url('dispatchin/'.$dispatch->id) }}">
                                        @method('PUT')
                                        @csrf
                                        <div class="form-row">
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-2" id="date" name="dispatchin_date" type="date" value="{{ $dispatch->dispatchin_date }}" placeholder="Enter dispatch in date here" />
                                                ...
                                                <select class="custom-select" id="reason" name="memo">
                                                    ...
                                                    <option value="yes" {{ $dispatch->memo == 'yes'?"selected":"" }}>Yes</option>
                                                    <option value="no" {{ $dispatch->memo == 'no'?"selected":"" }}>No</option>
                                                </select>
