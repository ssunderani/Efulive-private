                                        ...
                                        <div class="form-row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-2" id="date" name="dispose_date" type="date" value="{{ $disposal->dispose_date }}" placeholder="Enter dispose date here" />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-2 p_date" id="p_date" name="purchase_date" type="text" value="{{ $disposal->inventory->purchase_date }}" placeholder="Enter purchase date here" readonly/>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="hdate">Handover Date</label>
                                                        <input class="form-control py-2" id="hdate" name="handover_date" type="date" value="{{ $disposal->handover_date }}" placeholder="Enter handover date here" />
