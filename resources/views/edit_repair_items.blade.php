                    ...
                    <div class="col-md-1 col-lg-1"></div>
                            <div class="col-sm-10 col-md-10 col-lg-10">
                                <div class="card border-0 rounded-lg mt-3">
                                    <div class="card-body">
                                        <form  method="POST" action="{{ url('update_asset_repair/'.$repairing_item->id) }}">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select category" id="category" name="category_id">
                                                    ...
                                                    @if($category->id == $repairing_item->category_id)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value="{{$repairing_item->subcategory->id}}">{{$repairing_item->subcategory->sub_cat_name}}</option>
                                                </select>
                                        ...
                                        <div class="form-row">
                                                ...
                                                <select class="custom-select repair_item" id="item" name="item_id">
                                                    <option value="{{ $repairing_item->item->id }}">{{ $repairing_item->item->product_sn }}</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-2" id="date" name="date" type="date" value="{{$repairing_item->date}}" placeholder="Enter date here" />
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-2 a_price" id="a_price" name="actual_price_value" type="text" value="{{$repairing_item->actual_price_value}}" placeholder="Enter Actual Price Value here"  />
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <label class="small mb-1" for="price">Repairing Cost</label>
                                                        <input class="form-control py-2 t_seperator" id="price" name="price_value" type="text" value="{{$repairing_item->price_value}}" placeholder="Enter Repairing Cost here" />
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="remarks" name="remarks" rows="4" placeholder="Enter Remarks here">{{$repairing_item->remarks}}</textarea>
                                                        <span class="small text-danger">{{ $errors->first('remarks') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group mt-4 mb-0">
                                            <input type="submit" name="repair_inventory" value="Update Repair" class="btn btn-primary btn-block">
                                            </div>
                                        </form>
                                    </div>
                                </div>
